...
public class LoginTest {
    ...
    public void adminAuthenticated() throws Exception {
        this.mockMvc.perform(get("/profile"))
                ...
                .andExpect(xpath("//div[@class='profile-header']/h2").string(containsString("Администратор")));
    }
    @Test
    ...
    public void userAuthenticated() throws Exception {
        this.mockMvc.perform(get("/profile"))
                .andDo(print())
                .andExpect(authenticated())
                .andExpect(xpath("//div[@class='profile-header']/h2").string(containsString("Работник")));
    }
}
